...
Plataforma digital oficial desarrollada para la **Asociación Nacional de Cazadores del Uruguay (ANCU)**, con respaldo tecnológico de **Astro** (`astroseguridad.lat` · **0800 2110**).
...
- `contacto.html`: Canal centralizado de atención con la línea **0800 2110** y WhatsApp.
...
├── contacto.html        # Canales de atención (0800 2110)
...
## 📞 Canales de Soporte
- **Línea Institucional ANCU:** 0800 2110

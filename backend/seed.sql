...
VALUES 
    ...
    ('brou_account_info', '110766786-00001', 'FINANCIAL', 'Cuenta BROU para Transferencias'),
    ('brou_account_titular', 'PHOYU MIRO GONZALO DAMIAN Y/O GIUMELLI ACOSTA CESAR ROBERTO', 'FINANCIAL', 'Titulares Cuenta BROU'),
